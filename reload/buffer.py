"""Verbatim from the sac-rnd reference implementation
(https://github.com/tinkoff-ai/sac-rnd), accompanying "Anti-Exploration by
Random Network Distillation" (Nikulin et al., 2023). Licensed under Apache 2.0
-- see LICENSE.sac-rnd. Unmodified; not part of this paper's contribution.
"""
import gym
import d4rl
import chex
